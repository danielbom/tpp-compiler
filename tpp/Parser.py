...
class Parser:
    ...
    def p_retorna_declaracao(self, p):
        ...
        p[0] = Tree('retorna_declaracao', [p[1], p[2]])
    ...
    def p_criacao_de_variaveis_declaracao(self, p):
        ...
        p[0] = Tree('criacao_de_variaveis_declaracao', [p[1], p[2], p[3]])
    ...
    def p_chamada_de_funcao_declaracao(self, p):
        ...
        p[0] = Tree('chamada_de_funcao_declaracao', [p[1], p[2], p[3], p[4]])
    ...
    def p_atribuicao_declaracao(self, p):
        ...
        p[0] = Tree('atribuicao_declaracao', [p[1], p[2], p[3]])
    ...
    def p_funcao_cabecalho(self, p):
        ...
        p[0] = Tree('cabecalho', [p[1], p[2], p[3], p[4]])
    ...
    def p_expressoes_booleanas(self, p):
        ...
        p[0] = Tree('expressoes_booleanas', [p[1], p[2]])
    ...
    def p_adiciona_ou_subtrai(self, p):
        ...
        p[0] = Tree('adiciona_ou_subtrai', [p[1], p[2]])
    ...
    def p_adiciona_ou_subtrai_adicao(self, p):
        ...
        p[0] = Tree('adiciona_ou_subtrai_terminal', [p[1], p[2]])
    ...
    def p_multiplica_ou_divide(self, p):
        ...
        p[0] = Tree('multiplica_ou_divide', [p[1], p[2]])
